<%-- 
    Document   : home
    Created on : May 3, 2021, 11:39:25 AM
    Author     : Win 10
--%>
      ...
      <div class="row">
        <div class="grid_4">
          <a href="#" class="banner "><div class="maxheight">
            <div class="fa fa-globe"></div>Liability Insurance</div>
          </a>
          <a href="#" class="banner "><div class="maxheight">
            <div class="fa fa-lightbulb-o"></div>Fire Insurance</div>
          </a>
          <a href="#" class="banner "><div class="maxheight1">
            <div class="fa fa-cog"></div>Property Insurance</div>
          </a>
          <a href="#" class="banner "><div class="maxheight1">
            <div class="fa fa-briefcase"></div>Bussiness Insurance</div>
          </a>
        </div>
        <div class="grid_5">
          <h2>Strong <br> Stable <br> Safe</h2>
          Stable Insurance We help you run your business  in a secured way
        </div>
      </div>
    </div>
  </section>
